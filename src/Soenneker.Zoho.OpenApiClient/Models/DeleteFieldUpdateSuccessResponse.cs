...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class DeleteFieldUpdateSuccessResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Array containing the deleted field update action. Contains exactly one item.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Zoho.OpenApiClient.Models.DeleteFieldUpdateSuccessResponse"/> and sets the default values.
        /// </summary>
        public DeleteFieldUpdateSuccessResponse()
        {
        ...
        public static global::Soenneker.Zoho.OpenApiClient.Models.DeleteFieldUpdateSuccessResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.DeleteFieldUpdateSuccessResponse();
        }
        /// <summary>
