...
#nullable restore
        ...
        public static global::Soenneker.Zoho.OpenApiClient.Models.PostusertypeResponse201 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.PostusertypeResponse201();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "user_type", n => { UserType = n.GetCollectionOfObjectValues<global::Soenneker.Zoho.OpenApiClient.Models.UserTypeNested1>(global::Soenneker.Zoho.OpenApiClient.Models.UserTypeNested1.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
