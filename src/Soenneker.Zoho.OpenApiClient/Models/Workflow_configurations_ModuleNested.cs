...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class Workflow_configurations_ModuleNested : IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Zoho.OpenApiClient.Models.Workflow_configurations_ModuleNested"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Zoho.OpenApiClient.Models.Workflow_configurations_ModuleNested CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.Workflow_configurations_ModuleNested();
        }
        /// <summary>
