...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class DetailsNestedForSectionUpdateSchema : IParsable
    {
        /// <summary>Indicates that the workflow should be repeated every time a record is updated, mandatory if the trigger value is section_update.</summary>
        public bool? Repeat { get; set; }
        /// <summary>Specify the unique IDs of all the sections, based on which you want to trigger the Workflow rule.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Zoho.OpenApiClient.Models.DetailsNestedForSectionUpdateSchema"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Zoho.OpenApiClient.Models.DetailsNestedForSectionUpdateSchema CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.DetailsNestedForSectionUpdateSchema();
        }
        /// <summary>
