...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class FiscalInvalidCalendarErrorDetails : IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Zoho.OpenApiClient.Models.FiscalInvalidCalendarErrorDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Zoho.OpenApiClient.Models.FiscalInvalidCalendarErrorDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.FiscalInvalidCalendarErrorDetails();
        }
        /// <summary>
