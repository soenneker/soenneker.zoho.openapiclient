...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class DataNestedRemindAtItem : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Zoho.OpenApiClient.Models.DataNestedRemindAtItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Zoho.OpenApiClient.Models.DataNestedRemindAtItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.DataNestedRemindAtItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "period", n => { Period = n.GetEnumValue<global::Soenneker.Zoho.OpenApiClient.Models.DataNestedRemindAtItemPeriod>(); } },
