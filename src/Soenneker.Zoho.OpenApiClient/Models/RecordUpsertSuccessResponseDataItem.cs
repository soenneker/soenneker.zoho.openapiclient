...
#nullable enable
        public global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemDetails? Details { get; set; }
#nullable restore
#else
        public global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemDetails Details { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItem();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemAction>(); } },
                { "code", n => { Code = n.GetEnumValue<global::Soenneker.Zoho.OpenApiClient.Models.SuccessCode>(); } },
                { "details", n => { Details = n.GetObjectValue<global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemDetails>(global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemDetails.CreateFromDiscriminatorValue); } },
                { "duplicate_field", n => { DuplicateField = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemAction>("action", Action);
            writer.WriteEnumValue<global::Soenneker.Zoho.OpenApiClient.Models.SuccessCode>("code", Code);
            writer.WriteObjectValue<global::Soenneker.Zoho.OpenApiClient.Models.RecordUpsertSuccessResponseDataItemDetails>("details", Details);
