...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class VariablesListResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Array of variable objects, each containing the variable details such as name, API name, type, value, and variable group.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Zoho.OpenApiClient.Models.VariablesListResponse"/> and sets the default values.
        /// </summary>
        public VariablesListResponse()
        {
        ...
        public static global::Soenneker.Zoho.OpenApiClient.Models.VariablesListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.VariablesListResponse();
        }
        /// <summary>
