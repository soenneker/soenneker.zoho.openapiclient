...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class ScoringRulesPutSuccessResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Update results for all requested scoring rules.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Zoho.OpenApiClient.Models.ScoringRulesPutSuccessResponse"/> and sets the default values.
        /// </summary>
        public ScoringRulesPutSuccessResponse()
        {
        ...
        public static global::Soenneker.Zoho.OpenApiClient.Models.ScoringRulesPutSuccessResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.ScoringRulesPutSuccessResponse();
        }
        /// <summary>
