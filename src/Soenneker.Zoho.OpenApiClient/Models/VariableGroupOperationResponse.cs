...
namespace Soenneker.Zoho.OpenApiClient.Models
{
    ...
    public partial class VariableGroupOperationResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Represents an array containing the per-item operation status for the updated variable group.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Zoho.OpenApiClient.Models.VariableGroupOperationResponse"/> and sets the default values.
        /// </summary>
        public VariableGroupOperationResponse()
        {
        ...
        public static global::Soenneker.Zoho.OpenApiClient.Models.VariableGroupOperationResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Zoho.OpenApiClient.Models.VariableGroupOperationResponse();
        }
        /// <summary>
